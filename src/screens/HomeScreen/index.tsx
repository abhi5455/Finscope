        ...
        <SafeAreaView className="flex-1 bg-gray-800">
            ...
            >
                <ScrollView className="flex-1 px-6 pt-8">
                    {/* Header Section */}
                    <View className="mb-8 flex flex-row justify-center items-start">
                    ...
                    <View className="mb-6">
                        ...
                        <TouchableOpacity
                            className="border-2 border-dashed border-gray-600 rounded-2xl p-6 items-center justify-center mt-4 mb-40">
                            <View className="flex-row items-center">
                                <View className="w-6 h-6 bg-green-500 rounded-full items-center justify-center mr-2">
                                    <Text className="text-white text-sm font-interSemiBold">+</Text>
                                </View>
                                <Text className="text-primary text-base font-interSemiBold">
                                    Add New Allocation
                                </Text>
